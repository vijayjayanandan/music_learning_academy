...
class TestStudentFlow:
    ...
    def test_01_student_dashboard(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_01_dashboard.png"))
    ...
    def test_02_enrollments(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_02_enrollments.png"))
    ...
    def test_03_course_list(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_03_courses.png"))
    ...
    def test_04_course_detail(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_04_course_detail.png"))
        assert "Server Error" not in student_page.content()

    def test_05_practice_journal(self, e2e_server, student_page, screenshot_dir):
        _goto_home(student_page, e2e_server)
        click_sidebar(student_page, "Practice")
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_05_practice.png"))
        assert "Server Error" not in student_page.content()
    ...
    def test_06_practice_form_on_list(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.wait_for_load_state("networkidle")
        _remove_debug_toolbar(student_page)
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_06_practice_form.png"))
    ...
    def test_07_music_tools_metronome(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.wait_for_load_state("networkidle")
        _remove_debug_toolbar(student_page)
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_07_metronome.png"))
        assert "Server Error" not in student_page.content()
    ...
    def test_08_music_tools_tuner(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.wait_for_load_state("networkidle")
        _remove_debug_toolbar(student_page)
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_08_tuner.png"))
        assert "Server Error" not in student_page.content()
    ...
    def test_09_library(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.wait_for_load_state("networkidle")
        _remove_debug_toolbar(student_page)
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_09_library.png"))
        assert "Server Error" not in student_page.content()
    ...
    def test_10_notifications(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.wait_for_load_state("networkidle")
        _remove_debug_toolbar(student_page)
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_10_notifications.png"))
        assert "Server Error" not in student_page.content()
    ...
    def test_11_profile(self, e2e_server, student_page, screenshot_dir):
        ...
        student_page.wait_for_load_state("networkidle")
        _remove_debug_toolbar(student_page)
        student_page.screenshot(path=os.path.join(screenshot_dir, "student_11_profile.png"))
        assert "Server Error" not in student_page.content()

    def test_12_mobile_viewport(self, e2e_server, browser, student_storage, screenshot_dir):
        ctx = browser.new_context(storage_state=student_storage, viewport={"width": 375, "height": 812})
        p = ctx.new_page()
        p.goto(f"{e2e_server}/")
