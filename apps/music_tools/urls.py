...
urlpatterns = [
    ...
    # Ear training
    path("ear-training/", views.EarTrainingListView.as_view(), name="ear-training-list"),
    path("ear-training/<int:pk>/", views.EarTrainingPlayView.as_view(), name="ear-training-play"),
    # Recitals
    ...
    path("recitals/<int:pk>/", views.RecitalDetailView.as_view(), name="recital-detail"),
    # AI Analysis
