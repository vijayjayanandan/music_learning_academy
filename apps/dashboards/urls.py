...
urlpatterns = [
    ...
    path(
        "dashboard/admin/", views.AdminDashboardView.as_view(), name="admin-dashboard"
    ),
    path(
    ...
    path(
        ...
        views.student_onboarding_submit,
        name="student-onboarding-submit",
    ),
    path(
        "dashboard/analytics/",
        views.OwnerAnalyticsView.as_view(),
        name="owner-analytics",
    ),
    path(
        "dashboard/partials/stats/",
        views.DashboardStatsPartialView.as_view(),
