...
urlpatterns = [
    ...
    path(
        "partials/badge/",
        views.NotificationBadgePartialView.as_view(),
        name="notification-badge-partial",
    ),
    # Messaging
    ...
    path(
        "messages/with/<int:pk>/",
        views.ConversationWithView.as_view(),
        name="conversation-with",
    ),
    path(
        "messages/compose/", views.ComposeMessageView.as_view(), name="message-compose"
    ),
    path(
        "messages/<int:pk>/", views.MessageThreadView.as_view(), name="message-thread"
    ),
    path(
