...
| Where | What | Template |
|-------|------|----------|
| `academies/views.py:InviteMemberView` | Invitation email | Inline HTML |
| `academies/views.py:ResendInvitationView` | Resend invitation | Inline HTML (duplicated — DEBT-001) |
